...
use test::CounterCompressedAccount;
...
async fn test() {
    ...
    let compressed_accounts = test_indexer.get_compressed_accounts_by_owner(&test::ID);
    ...
    R: RpcConnection + MerkleTreeExt,
{
    ...
    let cpi_signer = find_cpi_signer(&test::ID);

    let accounts = test::accounts::Create {
        signer: payer.pubkey(),
    ...
    R: RpcConnection + MerkleTreeExt,
{
    ...
    let accounts = test::accounts::Increment {
        signer: payer.pubkey(),
        light_system_program: PROGRAM_ID_LIGHT_SYSTEM,
        account_compression_program: PROGRAM_ID_ACCOUNT_COMPRESSION,
        account_compression_authority,
    ...
    R: RpcConnection + MerkleTreeExt,
{
    ...
    let accounts = test::accounts::Delete {
        signer: payer.pubkey(),
        light_system_program: PROGRAM_ID_LIGHT_SYSTEM,
        account_compression_program: PROGRAM_ID_ACCOUNT_COMPRESSION,
        account_compression_authority,
